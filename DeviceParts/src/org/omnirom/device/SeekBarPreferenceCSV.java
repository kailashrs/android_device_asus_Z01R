...
public class SeekBarPreferenceCSV extends Preference implements
        OnSeekBarChangeListener {

    public static int maximum = 383;
    ...
    public SeekBarPreferenceCSV(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
